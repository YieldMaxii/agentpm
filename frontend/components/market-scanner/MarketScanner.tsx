...
export function MarketScanner() {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {/* Column Headers */}
      <div className="grid grid-cols-[16px_1fr_60px_70px] gap-2 px-3 py-2 text-[10px] font-medium text-muted-foreground uppercase tracking-wider border-b border-border/50">
        <span></span>
        <span>Event</span>
